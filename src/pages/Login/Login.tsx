            ...
            <section className='loginSection'>
                <div className="loginBox">
                    <div className="logo text-center d-flex flex-column align-items-center gap-0">
                        ...
                        <h5 className='fw-bold'>Login to WiFre</h5>
                    </div>
                    ...
                    <div className="wrapper mt-3 card border">
                        <form>
                            ...
                            <div className="form-group">
                                <Button className="btn btn-primary btn-lg w-100 btn-big">Sign in</Button>
                            </div>

                            <div className="form-group text-center mb-0">
                                <Link to={'/forgot-password'} className='link d-block mt-3'>FORGOT PASSWORD</Link>
                                ...
                                <img src={GoogleIcon} alt="GoogleIcon" width="24px" /> &nbsp; Sign In with google
                                </Button>
                            </div>
                        </form>
                    </div>
